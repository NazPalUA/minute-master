...
export async function ActionButtons({ lang }: { lang: Language }) {
  ...
  return (
    <div className="flex flex-col justify-center gap-4 sm:flex-row">
      <Button
        size="lg"
        className="group from-primary hover:shadow-primary/25 relative overflow-hidden bg-gradient-to-r to-blue-600 px-6 py-5 text-base font-medium transition-all duration-300 hover:shadow-lg"
        asChild
      >
      ...
      <Button
        size="lg"
        variant="outline"
        className="group border-input hover:border-primary hover:text-primary flex items-center border px-6 py-5 text-base font-medium transition-all duration-300"
      >
